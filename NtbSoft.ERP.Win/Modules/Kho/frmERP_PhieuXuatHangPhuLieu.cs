...
{
    public partial class frmERP_PhieuXuatHangPhuLieu : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_PhieuXuatHangPhuLieu()
        {
            URL = (string)settingsReader.GetValue("URL_PXHPL", typeof(String));
            InitializeComponent();
