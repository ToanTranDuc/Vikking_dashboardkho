...
{
    public partial class frmERP_DangKyVatTuNguyenLieu : DevExpress.XtraEditors.XtraForm
    { 
        ...
        public frmERP_DangKyVatTuNguyenLieu()
        {
            URL = (string)settingsReader.GetValue("URL_DangKyVTNL", typeof(String));
            InitializeComponent();
