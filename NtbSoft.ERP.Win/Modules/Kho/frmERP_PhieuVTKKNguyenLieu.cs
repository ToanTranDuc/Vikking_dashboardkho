...
{
    public partial class frmERP_PhieuVTKKNguyenLieu : DevExpress.XtraEditors.XtraForm
    { 
        ...
        public frmERP_PhieuVTKKNguyenLieu()
        {
            URL = (string)settingsReader.GetValue("URL_PKKNL", typeof(String));
            InitializeComponent();
