...
{
    public partial class frmERP_KiemPhuLieu : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_KiemPhuLieu()
        {
            URL = (string)settingsReader.GetValue("URL_KiemPhuLieu", typeof(String));
            InitializeComponent();
