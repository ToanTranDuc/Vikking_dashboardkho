...
{
    public partial class frmERP_XacNhanHangPhuLieu : DevExpress.XtraEditors.XtraForm
    { 
        ...
        public frmERP_XacNhanHangPhuLieu()
        {
            URL = (string)settingsReader.GetValue("URL_XacNhanHangXuatPL", typeof(String));
            InitializeComponent();
