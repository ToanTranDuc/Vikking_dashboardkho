...
{
    public partial class frmERP_DangKyVatTuPL : DevExpress.XtraEditors.XtraForm
    { 
        ...
        public frmERP_DangKyVatTuPL()
        {
            URL = (string)settingsReader.GetValue("URL_DangKyVTPL", typeof(String));
            InitializeComponent();
