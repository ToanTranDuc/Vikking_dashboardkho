...
{
    public partial class frmERP_BCPhuLieu : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_BCPhuLieu()
        {
            URL = (string)settingsReader.GetValue("URL_BCPhuLieu", typeof(String));
            InitializeComponent();
