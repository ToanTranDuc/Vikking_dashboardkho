...
{
    public partial class frmERP_BienBanMoKienPhuLieu : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_BienBanMoKienPhuLieu()
        {
            URL = (string)settingsReader.GetValue("URL_BBMKPL", typeof(String));
            InitializeComponent();
            InitializeChromiumBrowser();
            InitializeDataGridView();
            this.Load += frmKTXuatHangPL;
            this.WindowState = FormWindowState.Maximized;
            InitializeComponent();
        }
        private void frmKTXuatHangPL(object sender, EventArgs e)
        {
