...
{
    public partial class frmERP_PhieuTQVatTuPL : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_PhieuTQVatTuPL()
        {
            try
            {
                URL = (string)settingsReader.GetValue("URL_TQPL", typeof(String));
                InitializeComponent();
                InitializeChromiumBrowser();
                InitializeDataGridView();
                this.Load += frmPhieuTQVTPL;
        ...
        private void frmPhieuTQVTPL(object sender, EventArgs e)
        {
