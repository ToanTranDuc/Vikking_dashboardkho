...
{
    public partial class frmERP_CapThemBNDH : DevExpress.XtraEditors.XtraForm
    { 
        ...
        public frmERP_CapThemBNDH()
        {
            URL = (string)settingsReader.GetValue("URL_CAPTHEM_BN", typeof(String));
            InitializeComponent();
