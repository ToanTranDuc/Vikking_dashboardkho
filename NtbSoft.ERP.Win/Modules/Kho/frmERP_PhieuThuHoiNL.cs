...
{
    public partial class frmERP_PhieuThuHoiNL : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_PhieuThuHoiNL()
        {
            try
            {
                URL = (string)settingsReader.GetValue("URL_THNL", typeof(String));
                InitializeComponent();
                InitializeChromiumBrowser();
                InitializeDataGridView();
                this.Load += frmPhieuThuHoi;
        ...
        private void frmPhieuThuHoi(object sender, EventArgs e)
        {
