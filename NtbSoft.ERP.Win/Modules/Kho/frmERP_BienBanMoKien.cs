...
{
    public partial class frmERP_BienBanMoKien : DevExpress.XtraEditors.XtraForm
    { 
        ...
        public frmERP_BienBanMoKien()
        {
            URL = (string)settingsReader.GetValue("URL_BBMK", typeof(String));
            InitializeComponent();
