...
{
    public partial class frmERP_PhieuTQVatTuNL : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_PhieuTQVatTuNL()
        {
            try
            {
                URL = (string)settingsReader.GetValue("URL_TQNL", typeof(String));
                InitializeComponent();
                InitializeChromiumBrowser();
                InitializeDataGridView();
                this.Load += frmPhieuTQVTNL;
        ...
        private void frmPhieuTQVTNL(object sender, EventArgs e)
        {
