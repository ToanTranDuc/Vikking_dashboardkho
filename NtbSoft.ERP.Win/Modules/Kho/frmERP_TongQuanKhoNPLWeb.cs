...
{
    public partial class frmERP_TongQuanKhoNPLWeb : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_TongQuanKhoNPLWeb()
        {
            try
            {
                URL = (string)settingsReader.GetValue("URL_TQKHOPL", typeof(String));
                InitializeComponent();
