...
{
    public partial class frmERP_BCKiemVai : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_BCKiemVai()
        {
            URL = (string)settingsReader.GetValue("URL_BCKiemVai", typeof(String));
            InitializeComponent();
