...
{
    public partial class frmERP_CapThemNPL : DevExpress.XtraEditors.XtraForm
    { 
        ...
        public frmERP_CapThemNPL()
        {
            URL = (string)settingsReader.GetValue("URL_CAPTHEMNPL", typeof(String));
            InitializeComponent();
