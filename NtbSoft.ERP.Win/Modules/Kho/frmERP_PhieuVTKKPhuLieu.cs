...
{
    public partial class frmERP_PhieuVTKKPhuLieu : DevExpress.XtraEditors.XtraForm
    { 
        ...
        public frmERP_PhieuVTKKPhuLieu()
        {
            URL = (string)settingsReader.GetValue("URL_PhieuVTKKPL", typeof(String));
            InitializeComponent();
