...
{
    public partial class frmERP_PhieuXuatHang : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_PhieuXuatHang()
        {
            try
            {
                URL = (string)settingsReader.GetValue("URL_PXUATHANG", typeof(String));
                InitializeComponent();
