...
{
    public partial class frmERP_PhieuThuHoiPL : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_PhieuThuHoiPL()
        {
            try
            {
                URL = (string)settingsReader.GetValue("URL_THPL", typeof(String));
                InitializeComponent();
                InitializeChromiumBrowser();
                InitializeDataGridView();
                this.Load += frmPhieuThuHoiPL;
        ...
        private void frmPhieuThuHoiPL(object sender, EventArgs e)
        {
