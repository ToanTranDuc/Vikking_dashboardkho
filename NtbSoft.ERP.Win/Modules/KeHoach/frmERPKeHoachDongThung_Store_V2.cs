...
{
    public partial class frmERPKeHoachDongThung_Store_V2 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERPKeHoachDongThung_Store_V2(string MaDH, string MaDHDisplay, string MaHang, string TenHang, string POID, string MaPKL)
        {
            InitializeComponent();
