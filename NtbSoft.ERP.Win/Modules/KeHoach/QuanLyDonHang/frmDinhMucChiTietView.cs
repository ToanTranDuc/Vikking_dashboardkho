...
{
    public partial class frmDinhMucChiTietView : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmDinhMucChiTietView(string makh, string khachhang, string mahang, string nhomvt, string mavtid, string mavt, string chitiet, string mauvt, string mausp, string madot, string dot, string manhom, string mauvtid, string khovaiid, bool tachmau,string isneww, string mavtghep, string SLDinhMuc = "", string MaMauID = "", bool checkSave = false, bool isEdit = true)
        {
            InitializeComponent();
