...
namespace NtbSoft.ERP.Win.Modules.QuanLyDonHang
{
    public partial class frmCanDoiDHChiaChuyen : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmCanDoiDHChiaChuyen(string maDH, string maLenhSX)
        {
            InitializeComponent();
        ...
        private void btnSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            string url = $"{URL}ERPDonHangTong/GetChuyen?action=PostChiaChuyen&para={_maDH}&para2={_LineGoc}&para3={Line}&para5={_maLenhSX}";
            string json = Task.Run(async () => { return await _clientExtension.GetAsnyc(url); }).Result;
