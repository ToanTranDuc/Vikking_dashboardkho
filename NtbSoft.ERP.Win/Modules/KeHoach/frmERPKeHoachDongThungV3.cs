...
{
    public partial class frmERPKeHoachDongThungV3 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERPKeHoachDongThungV3(string MaDH,string MaDHDisplay, string MaHang, string TenHang, string POID, string MaPKL)
        {
            InitializeComponent();
                        ...
                        foreach (var itemData in _dtDistinctDT)
                        {
                            ...
                            foreach (var itemMau in _dtDistinct_Mau)
                            {
                                ...
                                for (int i = 0; i < _dtTemp.Rows.Count; i++)
                                {
                                    ...
                                    _dr["ChieuDai"] = Convert.ToDouble(_dtTemp.Rows[i]["ChieuDai"]);
                                    _dr["ChieuRong"] = Convert.ToDouble(_dtTemp.Rows[i]["ChieuRong"]);
                                    _dr["ChieuCao"] = Convert.ToDouble(_dtTemp.Rows[i]["ChieuCao"]);
                                    _dr["KyHieu"] = _dtTemp.Rows[i]["ChieuDai"] + "x" + _dtTemp.Rows[i]["ChieuRong"] + "x" + _dtTemp.Rows[i]["ChieuCao"];
                                    _dr["SttThung"] = ID;
                                    _dr["Chon"] = false;
                                    _dr["IsSave"] = false;
                                    ...
                                    if (_sltrongthung > 0)
                                    {
                                        ...
                                        if ((_sodu > 0 && _songuyen != 0) || CheckIsThungLe)
                                        {
                                            ...
                                            _drDu["ChieuDai"] = Convert.ToInt32(_dtTemp.Rows[i]["ChieuDai"]);
                                            _drDu["ChieuRong"] = Convert.ToInt32(_dtTemp.Rows[i]["ChieuRong"]);
                                            _drDu["ChieuCao"] = Convert.ToInt32(_dtTemp.Rows[i]["ChieuCao"]);
                                            _drDu["KyHieu"] = _dtTemp.Rows[i]["ChieuDai"] + "x" + _dtTemp.Rows[i]["ChieuRong"] + "x" + _dtTemp.Rows[i]["ChieuCao"];
                                            _drDu["IsThungLe"] = true;
                                            _drDu["SttThung"] = ID;
                                            _drDu["Chon"] = false;
                                            _drDu["IsSave"] = false;
                                            KhoiLuong = Math.Round(_sodu * NW, 1);
                                            TrongLuong = KhoiLuong + GW;
