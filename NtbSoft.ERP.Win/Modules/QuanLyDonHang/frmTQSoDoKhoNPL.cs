...
{
    public partial class frmTQSoDoKhoNPL : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmTQSoDoKhoNPL()
        {
            URL = (string)settingsReader.GetValue("URL_DetailKhoNPL", typeof(String));
            InitializeComponent();
            InitializeChromiumBrowser();
            InitializeDataGridView();
            this.Load += frmTongQuan;
            this.WindowState = FormWindowState.Maximized;
            InitializeComponent();
        }
        private void frmTongQuan(object sender, EventArgs e)
        {
