...
namespace NtbSoft.ERP.Win.Modules.POMuaHang
{
    ...
    public partial class frmERPPODanhGiaNCCNoiLV : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERPPODanhGiaNCCNoiLV()
        {
            InitializeComponent();
            URL = (string)settingsReader.GetValue("URL_DG_LV", typeof(String));
            InitializeComponent();
