...
{
    public partial class frmERPPODanhGiaNCC : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERPPODanhGiaNCC()
        {
            InitializeComponent();
            URL = (string)settingsReader.GetValue("URL_DG_NCC", typeof(String));
            InitializeComponent();
