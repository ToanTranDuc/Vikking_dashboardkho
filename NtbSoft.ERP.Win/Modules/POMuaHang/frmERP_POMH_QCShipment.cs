...
namespace NtbSoft.ERP.Win.Modules.POMuaHang
{
    ...
    public partial class frmERP_POMH_QCShipment : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERP_POMH_QCShipment(bool IsNPL,DataRow rowFocusedVatTu,DataRow rowFocusedSoKien)
        {
            InitializeComponent();
            URL = (string)settingsReader.GetValue("URL_QCShipmet", typeof(String));          
            InitializeChromiumBrowser();
            InitializeDataGridView();
            this.Load += LoadModules;
            this.WindowState = FormWindowState.Maximized;
            rowVatTu = rowFocusedVatTu;
            rowKien = rowFocusedSoKien;
            _IsNPL = IsNPL;
        }

        private void LoadModules(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeDataGridView()
        {
            ...
            string dynamicURL =  _IsNPL ? URL + "/InLine/BCDetail?module=0" : URL + "/InLine/BCTestingNPL?module=0";
