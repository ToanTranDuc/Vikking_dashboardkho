...
{
    public partial class frmERPPOTheoDoiNCC : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERPPOTheoDoiNCC()
        {
            InitializeComponent();
            URL = (string)settingsReader.GetValue("URL_TD_NCC", typeof(String));
            InitializeComponent();
