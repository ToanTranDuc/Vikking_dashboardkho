...
{
    public partial class frmERPBaoGiaNCC_MayMocTB : DevExpress.XtraEditors.XtraForm
    {
        ...
        bool _isDuyet = false;
        string LoaiCC = "MLNCC_22";
        SearchCheckSelection gridCheckMarksNhomMayMoc;

        public frmERPBaoGiaNCC_MayMocTB(string action, bool IsDuyet, string MaPhieuBG = "", string TenPhieu = "", string PhieuBGCopy = "")
        {
            InitializeComponent();
            ...
            {
              colDonGia,colGhiChu,colTienTe,colChietKhauBG,colThueBG,colDVThoiHanBH,colThoiHanBH,colDonViTinh,colLeadTime
            });
        ...
        private DataTable CreateDataTable_PhieuBaoGia_ChiTiet()
        {
            ...
            dt.Columns.Add("MaTB", typeof(string));
            dt.Columns.Add("TenTB", typeof(string));
            ...
            dt.Columns.Add("TenCT", typeof(string));
            dt.Columns.Add("MaNhom", typeof(string));
            dt.Columns.Add("TenNhom", typeof(string));
            dt.Columns.Add("MaLK", typeof(string));
            dt.Columns.Add("TenLK", typeof(string));
            dt.Columns.Add("MaCLLK", typeof(string));
            dt.Columns.Add("CLLK", typeof(string));
            dt.Columns.Add("DonVi", typeof(string));
            dt.Columns.Add("Status", typeof(bool));
            dt.Columns.Add("ThoiHanBH", typeof(int));
            ...
            dt.Columns.Add("LoaiMMTB", typeof(string));
            return dt;
        }
        ...
        private void SetupLayout()
        {
            ...
            riCombo.Items.AddRange(new object[] { "Ngày", "Tháng", "Năm" });
            LoadLoaiVatTu();

            // Gán vào column
            colDVThoiHanBH.ColumnEdit = riCombo;
            if (_action == "add")
            {
        ...
        private void LoadNhaCC()
        {
            try
            {
                string url = $"{URL}PhieuBaoGiaMMTB/GET?action=GetNCC&para1={SearchLookUpLoaiCC.EditValue?.ToString()}";                
                string json = Task.Run(async () => { return await _clientExtension.GetAsnyc(url); }).Result;
        ...
        private void LoadLoaiVatTu()
        {
            try
            {
                string url = $"{URL}PhieuBaoGiaMMTB/GET?action=LoaiCC";
                string json = Task.Run(async () => { return await _clientExtension.GetAsnyc(url); }).Result;
                DataTable tblNCC = JsonConvert.DeserializeObject<DataTable>(json);
                ...
                {
                    SearchLookUpLoaiCC.EditValue = LoaiCC;
                }
        ...
        private void SearchLookupDVTienTe_EditValueChanged(object sender, EventArgs e)
        {
            ...
            bgvVatTuMMTB.RefreshData();
            bgvVatTuMMTB.UpdateSummary();

            grvChiPhi.RefreshData();
            grvChiPhi.UpdateSummary();

            TinhToanTongGiaTri(bgvVatTuMMTB);
        }
        ...
        private void SetupGridView()
        {
            ...
            bgvVatTuMMTB.ColumnPanelRowHeight = 50;
        ...
        {
            string url = string.Format("{0}?action={1}", URL + "PhieuBaoGiaMMTB/Get", "GetDVTinh");
            string json = Task.Run(async () => { return await _clientExtension.GetAsnyc(url); }).Result;
            ...
            RepositoryItemSearchLookUpEdit rItemEdit = new RepositoryItemSearchLookUpEdit();
            rItemEdit.DataSource = tblThuVienChiPhi;
            rItemEdit.DisplayMember = "DonVi";
            rItemEdit.ValueMember = "DonVi";
            rItemEdit.ShowClearButton = false;
            rItemEdit.NullText = "[Chọn]";
            rItemEdit.ImmediatePopup = true;
            rItemEdit.TextEditStyle = TextEditStyles.Standard;
            rItemEdit.PopupFilterMode = DevExpress.XtraEditors.PopupFilterMode.Contains;
            ...
            if (dvView.Columns.Count == 0)
            {
                ...
                dvView.Columns.Add(new GridColumn { FieldName = "DonVi", Caption = "DonVi", Name = "rMaChiPhi", Visible = false });
                dvView.Columns.Add(new GridColumn { FieldName = "DonVi", Caption = "Đơn vị", Name = "rTenChiPhi", Visible = true, Width = 150 });
               
            }

            colDonViTinh.ColumnEdit = rItemEdit;
        ...
        private void UpdateTTThue4PhieuBG()
        {
            ...
            //clear cache Thue
            for (int i = 0; i <= bgvVatTuMMTB.RowCount; i++)
            {
                bgvVatTuMMTB.SetRowCellValue(i, colTTThue, "");
                bgvVatTuMMTB.SetRowCellValue(i, colThueBG, 0);
            }
        ...
        private void UpdateTTChietKhau4PhieuBG()
        {
            ...
            for (int i = 0; i < bgvVatTuMMTB.RowCount; i++)
            {
                bgvVatTuMMTB.SetRowCellValue(i, colTTChietKhau, "");
                bgvVatTuMMTB.SetRowCellValue(i, colChietKhauBG, 0);
            }
        ...
        private void LoadPhieuBG()
        {
            try
            {
                ...
                string url = $"{URL}PhieuBaoGiaMMTB/GET?action=GetPhieuBG&para1={MaPhieu}";
                string json = Task.Run(async () => { return await _clientExtension.GetAsnyc(url); }).Result;
                ...
                DataTable dtMMTB = null;
                DataTable dtLinhKien = null;

                grcVatTuMMTB.DataSource = _tblPhieuBaoGia;
                bgvVatTuMMTB.ExpandAllGroups();
        ...
        private void SetLayoutPhieuBG_Detail(DataTable tblChiTietPhieu)
        {
            ...
            if (tblChiTietPhieu?.Rows?.Count > 0)
            {
                ...
                if (_action == "edit")
                {
                    ...
                    {
                        SoNgayHieuLuc = SoNgayHieuLuc / 360;
                    }
        ...
        private void bgvVatTuPhieuBG_NPL_PopupMenuShowing(object sender, PopupMenuShowingEventArgs e)
        {
            ...
            if (_isDuyet) return;
            int rowHandle = bgvVatTuMMTB.FocusedRowHandle;
           

            if (bgvVatTuMMTB.IsGroupRow(rowHandle))
            {
                rowHandle = bgvVatTuMMTB.GetDataRowHandleByGroupRowHandle(rowHandle);
            }
            ...
            DataRow rowFocused = bgvVatTuMMTB.GetDataRow(rowHandle);
            if (rowFocused == null)
            {
                return;
            }
            // Chỉ hiện menu khi chuột phải trên cell của cột TyLeMuaThem
            if (e.HitInfo.InRowCell && e.HitInfo.Column != null && lstColEdit.Contains(e.HitInfo.Column))
            {
            ...
            //        DataRow rowFocsed = bgvVatTuMMTB.GetFocusedDataRow() as DataRow;
            //        if (rowFocsed != null)
            //        {
        ...
        private void btnLuuPhieuBG_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                string url = $"{URL}PhieuBaoGiaMMTB/POSTPhieuBG?action=POST";

                DataTable tblHienThi = grcVatTuMMTB.DataSource as DataTable;
                ...
                rowPhieu["MaDVTTe"] = tblHienThi?.Rows[0]["DVTienTeVT"];
                ...
                foreach (DataRow row in tblHienThi.Rows)
                {
                    ...
                    bool Stattus = row["Status"] != DBNull.Value && Convert.ToBoolean(row["Status"]);
                    decimal thue = 0;
                    decimal chietkhau = 0;
                    ...
                    newRow["TenLK"] = row["TenLK"];
                    newRow["MaCLLK"] = row["MaCLLK"];                   
                    newRow["DonVi"] = row["DonVi"];
                    newRow["Status"] = Stattus;
                    newRow["DonGia"] = row["DonGia"] == DBNull.Value ? 0.0 : Convert.ToDouble(row["DonGia"]);
                    newRow["Thue"] = thue;
                    newRow["ChietKhau"] = chietkhau;
                    newRow["ThoiHanBH"] = row["ThoiHanBH"];
                    newRow["DVThoiHanBH"] = row["DVThoiHanBH"];
        ...
        private void btnDeleteVTBaoGia_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                DataTable tblPhieuVatTuBG = grcVatTuMMTB.DataSource as DataTable;
                ...
                int[] selectedHandles = bgvVatTuMMTB.GetSelectedRows();


                for (int i = selectedHandles.Length - 1; i >= 0; i--)
                {
                    int rowHandle = selectedHandles[i];
                    DataRow dr = bgvVatTuMMTB.GetDataRow(rowHandle);
                    if (dr == null) continue;
                    ...
                    if (dr["ID"].ToString() != "0")
                    {
                        ...
                        string url = $"{URL}PhieuBaoGiaMMTB/Delete?action=Delete&Para1={dr["ID"]}&Para2=None";
                        string result = Task.Run(async () => await _clientExtension.DeletedAsync(url)).Result;
                        if (result.ToLower() == "true")
                        {
                            clsWaitForm.ShowSuccessForm(this, 1000);
                ...
                grcVatTuMMTB.DataSource = tblPhieuVatTuBG;
                grcVatTuMMTB.RefreshDataSource();
        ...
        {
            int defaultThoiHanBG = 12;
            string defaultDonViTG = "Tháng";
            ...
            DataTable tbl = grcVatTuMMTB.DataSource as DataTable;
            frmSelectedMayMocTB frm = new frmSelectedMayMocTB(maLoaiCC, maNCC, TenNCC, (!string.IsNullOrEmpty(maPhieuBG) ? maPhieuBG : null), tbl, "", NgayBDHieuLuc);
            frm.ShowDialog();
            if (frm.tblVatTuSelected != null && frm.tblVatTuSelected.Rows.Count > 0)
            {
                ...
                foreach (DataRow vt in frm.tblVatTuSelected.Rows)
                {
                    ...
                    bool Stattus = vt["Status"] != DBNull.Value && Convert.ToBoolean(vt["Status"]);

                    DataRow newRow = _tblPhieuBaoGia.NewRow();                 
                    newRow["ID"] = 0;
                    newRow["STT"] = 0;
                    newRow["MaPhieuBG"] = _maPhieuBG;                                  
                    newRow["NhomCLCC"] = "MMTB";
                    newRow["MaNCC"] = maNCC;
                    newRow["ChungLoaiCC"] = vt["MaCL"];
                    newRow["TenPhieu"] = _tenPhieu;
                    newRow["IsDuyet"] = false;
                    newRow["MaTB"] = vt["MaTB"];
                    newRow["TenTB"] = Stattus ? vt["TenTB"] : vt["TenLK"];
                    newRow["MauMa"] = vt["MauMa"];
                    newRow["XuatXu"] = vt["XuatXu"];
                    newRow["HangSX"] = vt["HangSX"];
                    newRow["TenCL"] = vt["TenCL"];
                    newRow["TenCT"] = vt["TenCT"];
                    newRow["MaNhom"] = vt["MaNhom"];
                    newRow["TenNhom"] = vt["TenNhom"];
                    newRow["MaLK"] = vt["MaLK"];
                    newRow["TenLK"] = vt["TenLK"];
                    newRow["MaCLLK"] = vt["MaCLLK"];
                    newRow["CLLK"] = vt["CLLK"];
                    newRow["DonVi"] = string.IsNullOrEmpty(vt["DonVi"]?.ToString()) ? "pc" : vt["DonVi"];
                    newRow["Status"] = Stattus;
                    newRow["ThoiHanBH"] = defaultThoiHanBG;
                    newRow["DVThoiHanBH"] = defaultDonViTG;
                    ...
                    newRow["LoaiMMTB"] = Stattus ? "Máy móc & thiết bị" : "Linh kiện";
                    newRow["Leadtime"] = "";
        ...
        private void bgvVatTuPhieuBG_NPL_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                DataRow rowFocused = bgvVatTuMMTB.GetDataRow(e.FocusedRowHandle);
        ...
        private void LoadLichSuBG(DataRow rowFocused)
        {
            try
            {
                ...
                string url = $"{URL}PhieuBaoGiaMMTB/GET?action=GetLSBaoGia&para1={rowFocused["ID"]}";
                string json = Task.Run(async () => { return await _clientExtension.GetAsnyc(url); }).Result;
                if (json != "[]")
                {
        ...
        private void bgvVatTuPhieuBG_NPL_DataSourceChanged(object sender, EventArgs e)
        {
            try
            {
                var view = bgvVatTuMMTB;
                if (view == null || view.DataSource == null) return;

                if (bgvVatTuMMTB.RowCount > 0)
                {
                    DataRow rowFocused = bgvVatTuMMTB.GetDataRow(0);
                    if (rowFocused == null) return;
                    LoadLichSuBG(rowFocused);
                    bgvVatTuMMTB.FocusedRowHandle = 0;
                }
        ...
        private void bgvVatTuPhieuBG_NPL_ValidatingEditor(object sender, BaseContainerValidateEditorEventArgs e)
        {
            ...
            else if(view.FocusedColumn.FieldName == "ThoiHanBH")
            {
                if (!int.TryParse(Convert.ToString(e.Value), out int ThoiHanBH))
                {
                    e.Valid = false;
                    e.ErrorText = "Thời hạn bảo hành phải là số";
                    return;
                }
        ...
        private void DateEditBDHieuLuc_EditValueChanged(object sender, EventArgs e)
        {
            ...
            if (dateEdit != null)
            {
                ...
                // Ví dụ: không cho chọn ngày nhỏ hơn hôm nay
        ...
        private void dataLayoutControl2_Click(object sender, EventArgs e)
        {

        }

        private void spinMaxGH_EditValueChanged(object sender, EventArgs e)
        {
        ...
        private void layoutControl8_Click(object sender, EventArgs e)
        {

        }

        private void grcVatTuMMTB_Click(object sender, EventArgs e)
        {

        }

        private void layoutControl9_Click(object sender, EventArgs e)
        {
        ...
        private void layoutControl6_Click(object sender, EventArgs e)
        {

        }

        private void grcChiPhi_Click(object sender, EventArgs e)
        {
        ...
        private void layoutControl5_Click(object sender, EventArgs e)
        {

        }

        private void grcThue_Click(object sender, EventArgs e)
        {

        }

        private void layoutControl7_Click(object sender, EventArgs e)
        {

        }

        private void grcChietKhau_Click(object sender, EventArgs e)
        {
        ...
        private void grcLSBaoGia_Click(object sender, EventArgs e)
        {
        ...
        private void txtDGiaVatTu_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void txtChiPhiCoBan_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void txtChiPhiSauThueCK_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void spinSoThoiHanHL_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void cbxDonViTG_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void spinHThucThanhToan_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void spinMinGH_EditValueChanged(object sender, EventArgs e)
        {
