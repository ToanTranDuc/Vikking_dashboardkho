...
{
    public partial class frmERPPOPheDuyet : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmERPPOPheDuyet()
        {
            InitializeComponent();
            URL = (string)settingsReader.GetValue("URL_PheDuyet", typeof(String));
            InitializeComponent();
