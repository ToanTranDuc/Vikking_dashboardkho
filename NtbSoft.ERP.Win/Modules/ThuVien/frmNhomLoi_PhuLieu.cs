...
{
    public partial class frmNhomLoi_PhuLieu : DevExpress.XtraEditors.XtraForm
    {
        System.Configuration.AppSettingsReader settingsReader = new System.Configuration.AppSettingsReader();
        private HttpClientExtension _clientExtension;
        string URL = string.Empty;
        public frmNhomLoi_PhuLieu()
        {
            InitializeComponent();
        ...
        {
            string url = string.Format("{0}", URL + $"NhomLoiPL/Get?action=GetNhomLoi");
            string json = Task.Run(async () => { return await _clientExtension.GetAsnyc(url); }).Result;
            DataTable tbl = JsonConvert.DeserializeObject<DataTable>(json);
            int rowHandle = grvNhomLoi.FocusedRowHandle;
            grcNhomLoi.DataSource = tbl.Rows.Count == 0 ? CreateTblNhomLoi() : tbl;
        ...
        private void LoadCTNhomLoi()
        {
            ...
            string url = string.Format("{0}", URL + $"NhomLoiPL/Get?action=GetCTNhomLoi&&Para1={IDNhomLoi}");
            string json = Task.Run(async () => { return await _clientExtension.GetAsnyc(url); }).Result;
            DataTable tbl = JsonConvert.DeserializeObject<DataTable>(json);
        ...
        private void btnLuuNL_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            string url = string.Format("{0}", URL + $"NhomLoiPL/Post?action=SaveNL");
        ...
        private void btnLuuCT_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            string url = string.Format("{0}", URL + $"NhomLoiPL/Post?action=SaveCT");
        ...
        private void btnXoaNL_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (drFocus is null) return;
            string IDNhomLoi = drFocus["ID"].ToString();
            string url = string.Format("{0}", URL + $"NhomLoiPL/Delete?action=DeleteNL&&Id={IDNhomLoi}");
        ...
        private void btnXoaCT_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            string url = string.Format("{0}", URL + $"NhomLoiPL/Delete?action=DeleteCT&&Id={IDCTNhomLoi}");
            string json = Task.Run(async () => { return await _clientExtension.PostAsync(url, new DataTable()); }).Result;
            if (json.ToLower() == "true")
            {
                clsWaitForm.ShowSuccessForm(this, 2000);
        ...
        private DataTable CreateTblNhomLoi()
        {
            DataTable dt = new DataTable();
