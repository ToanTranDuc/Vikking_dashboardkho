...
-- =============================================================================
-- PHẦN 2: LỊCH PHÂN CÔNG PHỤ LIỆU (SP_LICH_PHAN_CONG_PHU_LIEU)
-- Tạo bảng ERP_LichPhanCongPhuLieu_Task và stored procedure quản lý lịch
-- =============================================================================

-- -----------------------------------------------------------------------------
-- Bước 1: Tạo bảng lưu trữ phân công (nếu chưa tồn tại)
-- -----------------------------------------------------------------------------
...
BEGIN
    ...
    -- =========================================================
    -- GetDayDetail
    -- Trả về 2 result set: Assignments + PickOrders cho 1 ngày
    -- =========================================================
    IF @Action = 'GetDayDetail'
    BEGIN
        -- Result Set 1: Assignments (phân công nhân viên)
        SELECT
            t.MaLenhSX,
            ''                         AS MaKhachHang,
            ''                         AS TenBrand,
        ...
        -- Result Set 2: PickOrders (lệnh soạn hàng)
        SELECT
            t.MaLenhSX,
            ''                         AS MaKhachHang,
            ''                         AS TenBrand,
    ...
    -- =========================================================
    -- GetFilterLists
    -- Danh sách nhân viên đã phân công (dùng cho dropdown)
    -- =========================================================
    ...
    -- =========================================================
    -- GetPickOrderDetail
    -- Chi tiết phụ liệu cần soạn cho 1 lệnh sản xuất
    -- =========================================================
    ...
    -- =========================================================
    -- GetNhanVienList
    -- Danh sách nhân viên kho để chọn phân công
    -- =========================================================
    ...
    BEGIN
        ...
        ELSE
        BEGIN
            -- Fallback: lấy NV từ bảng Task hiện tại
            SELECT DISTINCT
                ISNULL(MaNV, '')  AS MaNV,
                ISNULL(TenNV, '') AS TenNV,
                'PB01'            AS MaPhongBan,
    ...
    -- =========================================================
    -- SavePhanCong
    -- Lưu hoặc cập nhật phân công nhân viên cho lệnh SX
    -- =========================================================
