...
{
    public class DonHangTongPOUSEREntity
    {

        public DonHangTongPOUSEREntity() { }

        public DonHangTongPOUSEREntity(string _maDH, string _poID, string _maMau, string _dauSizeID)
        {
            this.MaDH = _maDH;
            this.POID = _poID;
            this.MaMau = _maMau;
