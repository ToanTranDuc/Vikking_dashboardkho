...
{
    public class DonHangTongPOChiTietEntity
    {
        public DonHangTongPOChiTietEntity()
        {

        }

        public DonHangTongPOChiTietEntity(string _poID, string _maMau,string _dauSizeID)
        {
            this.POID = _poID;
            this.MaMau = _maMau;
