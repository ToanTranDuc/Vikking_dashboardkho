...
{
    public class ERPBaoCaoXuatNhapTonModel
    {
        public DataTable Get(string action, string para, string para2, string para3, string para4, string para5, string para6, string para7,string para8, string para9, string para10, string para11)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SP_ERPBaoCaoXuatNhapTon", conn);
                ...
                cmd.Parameters.AddWithValue("@parameter7", para8 ?? "");
                cmd.Parameters.AddWithValue("@parameter8", para9 ?? "");
                cmd.Parameters.AddWithValue("@parameter9", para10 ?? "");
                cmd.Parameters.AddWithValue("@parameter10", para11 ?? "");
        ...
        //    finally { if (conn != null) { conn.Close(); conn.Dispose(); } }
        //}
        //public string PostNK(string action, string para, string para2, string para3, string para4, DataTable tbl)
        //{
        //    SqlConnection conn = null;
        //    try
        //    {
